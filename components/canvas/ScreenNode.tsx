    ...
    <div className="group relative">
      <motion.div
        ...
        className={[
          ...
          selected || data.isConnectionTarget
            ? "border-accent"
            : "border-border",
          data.isConnectionTarget ? "shadow-[0_0_0_2px_var(--accent)]" : "",
        ].join(" ")}
      ...
      >
        ...
        <button
          ...
          className="nodrag absolute right-1 top-7 flex h-5 w-5 items-center justify-center text-text-secondary opacity-0 transition-opacity hover:text-danger focus-visible:opacity-100 group-hover:opacity-100"
        >
